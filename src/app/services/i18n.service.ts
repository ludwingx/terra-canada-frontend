...
export class I18nService {
  ...
  private translations: Translations = {
    ...
    'dashboard.stats_summary': { fr: 'Résumé des statistiques', es: 'Resumen de estadísticas' },
    ...
    'payments.loan_number': { fr: 'N° de prêt', es: 'N° Préstamo/Reserva' },
    'payments.map': { fr: 'Carte/Compte', es: 'Tarjeta/Cuenta' },
    'payments.verification': { fr: 'Vérification', es: 'Verificación' },
    ...
    'audit.action': { fr: 'Action', es: 'Acción' },
    'audit.recorded_by': { fr: 'Enregistré par', es: 'Registrado por' },
    'audit.history': { fr: 'Historique des audits', es: 'Historial de auditoría' },
